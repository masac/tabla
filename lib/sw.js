...
const CORE_ASSETS = [
  ...
  './manifest.json',
  './icon.svg',
  // 'lib/tabler-icons.css' nu mai e necesar separat — încorporat direct în
  // index.html, ca să funcționeze și în medii unde accesul e limitat la un
  // singur fișier (ex. deschidere prin managerul de fișiere pe tablă).
  './lib/jspdf.min.js',
  './lib/pdf-worker.js',
  './lib/pdf.min.js',
  './lib/three.min.js',
